...
function extractErrorMessage(data: any): string {
  ...
  return "Import-annotations request failed";
}
...
export async function POST(req: Request) {
  ...
  const candidates = [
    {
      url: `${backendBase}/plannotate/import_annotations`,
      proxyTarget: "import_annotations",
      backendRef: backendBase,
    },
    {
      url: `${backendOrigin}/plannotate/import_annotations`,
      proxyTarget: "import_annotations",
