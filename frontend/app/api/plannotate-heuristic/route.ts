...
function extractErrorMessage(data: any): string {
  ...
  return "Heuristic annotation request failed";
}
...
export async function POST(req: Request) {
  ...
  // Try heuristic endpoint on different base paths
  const candidates = [
    {
      url: `${backendBase}/plannotate/annotate_sequence_heuristic`,
      proxyTarget: "annotate_sequence_heuristic",
      backendRef: backendBase,
    },
    {
      url: `${backendOrigin}/plannotate/annotate_sequence_heuristic`,
      proxyTarget: "annotate_sequence_heuristic",
