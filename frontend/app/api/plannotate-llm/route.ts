...
function extractErrorMessage(data: any): string {
  ...
  return "LLM annotation request failed";
}
...
export async function POST(req: Request) {
  ...
  // Try LLM endpoint on different base paths
  const candidates = [
    {
      url: `${backendBase}/plannotate/annotate_sequence_llm`,
      proxyTarget: "annotate_sequence_llm",
      backendRef: backendBase,
    },
    {
      url: `${backendOrigin}/plannotate/annotate_sequence_llm`,
      proxyTarget: "annotate_sequence_llm",
