...
function extractErrorMessage(data: any): string {
  ...
  return "Cloning-feature scan request failed";
}
...
export async function POST(req: Request) {
  ...
  const candidates = [
    {
      url: `${backendBase}/cloning/scan_cloning_features`,
      proxyTarget: "scan_cloning_features",
      backendRef: backendBase,
    },
    {
      url: `${backendOrigin}/cloning/scan_cloning_features`,
      proxyTarget: "scan_cloning_features",
